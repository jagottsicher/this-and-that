...
int main(int argc, char *argv[]) {
    ...
    // but main screen is will be stadtscr showing an outcut of a padn so init pad here bigger than a screen
    WINDOW *mainscreen;
...
//    }
    for (int y = 0 ; y < 10 ; y++) {
        prefresh(mainscreen, 500 - parent_y + left_size + y, 0, 0 , 0, parent_y - left_size -1, parent_x-1);
        // napms(100);
        getch();
    }
