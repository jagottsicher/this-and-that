...
printf("\e[0mNormal Text\e[0m \e[1mbold/bright (depending on Terminal Settings)\e[0m \e[2mDimmed Text\e[0m\n\n\e[4mUnderlined Text\e[0m \e[5mBlinking Text (on Xterm)\e[0m \e[7m Reverse / inverted \e[0m \e[8mHidden\e[0m<=Hidden\n\n\e[5m\e[7m Reverse / inverted and blinking \e[0m \e[1m\e[2m\e[4m\e[5m\e[7m colored bold dimmed underlined blinking reversed /inverted Text\e[0m\n\n\e[1m\e[2m\e[4m\e[5m\e[7m\e[31m colored bold dimmed underlined blinking reversed /inverted Text\e[0m \e[1m\e[4m\e[32m colored bold underlined \e[0m");
    ...
    printf("\33[%d;%dH\e[30mBlack30 \e[2mBlack dimmed\n", 11,1);
    printf("\33[%d;%dH\e[90mDarkGrey90 \e[2mDarkGrey dimmed\n", 12,1);
    printf("\33[%d;%dH\e[37mlightGrey37 \e[2mlightGrey dimmed\n", 13,1);
    printf("\33[%d;%dH\e[2mDimmed2 \e[0m Normal0\n", 14,1);
    printf("\33[%d;%dH\e[1mBold1 \e[2mBold dimmed\n", 15,1);
...
while (1) {
    printf("\33[%d;%dH\e[0m\e[90mGLOWING\n", 9,4);
    msleep(1000);
    printf("\33[%d;%dH\e[0m\e[37mGLOWING\n", 9,4);
    msleep(1000);
    printf("\33[%d;%dH\e[0m\e[2mGLOWING\n", 9,4);
    msleep(1000);
    printf("\33[%d;%dH\e[0m\e[0mGLOWING\n", 9,4);
    msleep(1000);
    printf("\33[%d;%dH\e[1m\e[2mGLOWING\n", 9,4);
    msleep(1000);
    printf("\33[%d;%dH\e[1m\e[97mGLOWING\n", 9,4);
    msleep(1000);
    printf("\33[%d;%dH\e[1m\e[2mGLOWING\n", 9,4);
    msleep(1000);
    printf("\33[%d;%dH\e[0m\e[0mGLOWING\n", 9,4);
